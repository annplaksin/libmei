...
namespace mei
{
    ...
    /// <textLang/>
    /// </summary>
    public class TextLang : MeiElement, IAttCommon, IAttCommonPart, IAttBibl, IAttFacsimile, IAttLang
    {
    ...
    public XAttribute GetOtherLangs()
    {
