...
namespace mei
{
    ...
    /// <add/>
    /// </summary>
    public class Add : MeiElement, IAttCommon, IAttCommonPart, IAttFacsimile, IAttResponsibility, IAttSource, IAttEvidence, IAttLang, IAttHandident, IAttSequence, IAttTyped
    {
