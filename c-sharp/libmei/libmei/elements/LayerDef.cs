...
namespace mei
{
    ...
    /// <layerDef/>
    /// </summary>
    public class LayerDef : MeiElement, IAttCommonPart, IAttDeclaring, IAttDurationDefault, IAttBeamingLog, IAttOctavedefault, IAttTransposition, IAttLabelsAddl, IAttBeamingVis, IAttTextstyle, IAttVisibility, IAttInstrumentident
    {
