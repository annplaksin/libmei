...
namespace mei
{
    ...
    /// <expan/>
    /// </summary>
    public class Expan : MeiElement, IAttCommon, IAttCommonPart, IAttResponsibility, IAttSource, IAttEvidence, IAttFacsimile, IAttLang, IAttHandident, IAttSequence, IAttTyped
    {
