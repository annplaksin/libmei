...
namespace mei
{
    ...
    /// <damage/>
    /// </summary>
    public class Damage : MeiElement, IAttAgentident, IAttCommon, IAttCommonPart, IAttExtent, IAttFacsimile, IAttHandident, IAttLang, IAttTyped
    {
