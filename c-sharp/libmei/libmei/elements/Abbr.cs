...
namespace mei
{
    ...
    /// <abbr/>
    /// </summary>
    public class Abbr : MeiElement, IAttCommon, IAttCommonPart, IAttResponsibility, IAttSource, IAttEvidence, IAttFacsimile, IAttLang, IAttHandident, IAttSequence, IAttTyped
    {
