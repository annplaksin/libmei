...
namespace mei
{
  ...
  /// </summary>
  public interface IAttChordVis : IMEiAtt, IAttAltsym, IAttColor, IAttEnclosingchars, IAttExtsym, IAttRelativesize, IAttStems, IAttTypography, IAttVisibility, IAttVisualoffsetHo, IAttVisualoffsetTo, IAttXy, IAttChordVisCmn
  {
  ...
  public static class AttChordVis_extensions
  {
    ...
    public static XAttribute GetCluster(this IAttChordVis e)
    {
