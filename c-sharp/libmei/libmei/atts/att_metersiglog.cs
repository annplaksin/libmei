...
namespace mei
{
  ...
  public static class AttMeterSigLog_extensions
  {
    ...
    public static XAttribute GetCount(this IAttMeterSigLog e)
    {
    ...
    public static XAttribute GetSym(this IAttMeterSigLog e)
    {
    ...
    public static XAttribute GetUnit(this IAttMeterSigLog e)
    {
