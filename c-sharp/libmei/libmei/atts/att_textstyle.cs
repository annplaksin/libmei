...
namespace mei
{
  ...
  public static class AttTextstyle_extensions
  {
    ...
    public static XAttribute GetTextFam(this IAttTextstyle e)
    {
    ...
    public static XAttribute GetTextName(this IAttTextstyle e)
    {
    ...
    public static XAttribute GetTextSize(this IAttTextstyle e)
    {
    ...
    public static XAttribute GetTextStyle(this IAttTextstyle e)
    {
    ...
    public static XAttribute GetTextWeight(this IAttTextstyle e)
    {
