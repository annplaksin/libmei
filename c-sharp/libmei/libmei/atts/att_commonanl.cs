...
namespace mei
{
  ...
  /// </summary>
  public interface IAttCommonAnl : IMEiAtt, IAttAlignment
  {
  ...
  public static class AttCommonAnl_extensions
  {
    ...
    public static XAttribute GetCorresp(this IAttCommonAnl e)
    {
    ...
    public static XAttribute GetNext(this IAttCommonAnl e)
    {
    ...
    public static XAttribute GetPrev(this IAttCommonAnl e)
    {
    ...
    public static XAttribute GetSameas(this IAttCommonAnl e)
    {
    ...
    public static XAttribute GetSynch(this IAttCommonAnl e)
    {
