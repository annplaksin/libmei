...
namespace mei
{
  ...
  /// </summary>
  public interface IAttScoreDefGes : IMEiAtt, IAttChannelized, IAttTimebase, IAttMiditempo, IAttMmtempo
  {
  ...
  public static class AttScoreDefGes_extensions
  {
    ...
    public static XAttribute GetTunePname(this IAttScoreDefGes e)
    {
    ...
    public static XAttribute GetTuneHz(this IAttScoreDefGes e)
    {
    ...
    public static XAttribute GetTuneTemper(this IAttScoreDefGes e)
    {
