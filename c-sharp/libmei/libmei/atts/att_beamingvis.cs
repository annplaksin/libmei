...
namespace mei
{
  ...
  public static class AttBeamingVis_extensions
  {
    ...
    public static XAttribute GetBeamColor(this IAttBeamingVis e)
    {
    ...
    public static XAttribute GetBeamRend(this IAttBeamingVis e)
    {
    ...
    public static XAttribute GetBeamSlope(this IAttBeamingVis e)
    {
