...
namespace mei
{
  ...
  /// </summary>
  public interface IAttStaffDefVis : IMEiAtt, IAttCleffingVis, IAttDistances, IAttKeySigDefaultVis, IAttLabelsAddl, IAttLyricstyle, IAttMeterSigDefaultVis, IAttMultinummeasures, IAttOnelinestaff, IAttScalable, IAttTextstyle, IAttVisibility, IAttStaffDefVisCmn, IAttStaffDefVisMensural
  {
  ...
  public static class AttStaffDefVis_extensions
  {
    ...
    public static XAttribute GetGridShow(this IAttStaffDefVis e)
    {
    ...
    public static XAttribute GetLayerscheme(this IAttStaffDefVis e)
    {
    ...
    public static XAttribute GetLines(this IAttStaffDefVis e)
    {
    ...
    public static XAttribute GetLinesColor(this IAttStaffDefVis e)
    {
    ...
    public static XAttribute GetLinesVisible(this IAttStaffDefVis e)
    {
    ...
    public static XAttribute GetSpacing(this IAttStaffDefVis e)
    {
