...
namespace mei
{
  ...
  public static class AttSpacing_extensions
  {
    ...
    public static XAttribute GetSpacingPackexp(this IAttSpacing e)
    {
    ...
    public static XAttribute GetSpacingPackfact(this IAttSpacing e)
    {
    ...
    public static XAttribute GetSpacingStaff(this IAttSpacing e)
    {
    ...
    public static XAttribute GetSpacingSystem(this IAttSpacing e)
    {
