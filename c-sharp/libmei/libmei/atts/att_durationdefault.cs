...
namespace mei
{
  ...
  public static class AttDurationDefault_extensions
  {
    ...
    public static XAttribute GetDurDefault(this IAttDurationDefault e)
    {
    ...
    public static XAttribute GetNumDefault(this IAttDurationDefault e)
    {
    ...
    public static XAttribute GetNumbaseDefault(this IAttDurationDefault e)
    {
