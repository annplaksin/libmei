...
namespace mei
{
  ...
  public static class AttLinerend_extensions
  {
    ...
    public static XAttribute GetLendsym(this IAttLinerend e)
    {
    ...
    public static XAttribute GetLendsymsize(this IAttLinerend e)
    {
    ...
    public static XAttribute GetLstartsym(this IAttLinerend e)
    {
    ...
    public static XAttribute GetLstartsymsize(this IAttLinerend e)
    {
