...
namespace mei
{
  ...
  public static class AttKeySigDefaultLog_extensions
  {
    ...
    public static XAttribute GetKeyAccid(this IAttKeySigDefaultLog e)
    {
    ...
    public static XAttribute GetKeyMode(this IAttKeySigDefaultLog e)
    {
    ...
    public static XAttribute GetKeyPname(this IAttKeySigDefaultLog e)
    {
    ...
    public static XAttribute GetKeySig(this IAttKeySigDefaultLog e)
    {
    ...
    public static XAttribute GetKeySigMixed(this IAttKeySigDefaultLog e)
    {
