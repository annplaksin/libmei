...
namespace mei
{
  ...
  public static class AttMensuralVis_extensions
  {
    ...
    public static XAttribute GetMensurColor(this IAttMensuralVis e)
    {
    ...
    public static XAttribute GetMensurForm(this IAttMensuralVis e)
    {
    ...
    public static XAttribute GetMensurLoc(this IAttMensuralVis e)
    {
    ...
    public static XAttribute GetMensurOrient(this IAttMensuralVis e)
    {
    ...
    public static XAttribute GetMensurSize(this IAttMensuralVis e)
    {
