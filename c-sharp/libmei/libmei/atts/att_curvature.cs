...
namespace mei
{
  ...
  public static class AttCurvature_extensions
  {
    ...
    public static XAttribute GetBezier(this IAttCurvature e)
    {
    ...
    public static XAttribute GetBulge(this IAttCurvature e)
    {
    ...
    public static XAttribute GetCurvedir(this IAttCurvature e)
    {
