...
namespace mei
{
  ...
  public static class AttCleffingLog_extensions
  {
    ...
    public static XAttribute GetClefShape(this IAttCleffingLog e)
    {
    ...
    public static XAttribute GetClefLine(this IAttCleffingLog e)
    {
    ...
    public static XAttribute GetClefDis(this IAttCleffingLog e)
    {
    ...
    public static XAttribute GetClefDisPlace(this IAttCleffingLog e)
    {
