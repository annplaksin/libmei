...
namespace mei
{
  ...
  public static class AttMensuralLog_extensions
  {
    ...
    public static XAttribute GetMensurDot(this IAttMensuralLog e)
    {
    ...
    public static XAttribute GetMensurSign(this IAttMensuralLog e)
    {
    ...
    public static XAttribute GetMensurSlash(this IAttMensuralLog e)
    {
    ...
    public static XAttribute GetProportNum(this IAttMensuralLog e)
    {
    ...
    public static XAttribute GetProportNumbase(this IAttMensuralLog e)
    {
