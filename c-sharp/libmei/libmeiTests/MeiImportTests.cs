...
namespace mei.Tests
{
  ...
  public class MeiImportTests
  {
    ...
    {
      XElement testelement = new XElement("beam", new XElement("note","bla"));

      MeiElement compare = new Beam();
    ...
    {
      XElement testelement = new XElement("blubb", new XElement("note", new XElement("accid")));
    ...
    {
      XElement testelement = new XElement("beam", new XElement("note", new XAttribute("label","test")), new XAttribute(XNamespace.Xml + "id", "t-123"));
